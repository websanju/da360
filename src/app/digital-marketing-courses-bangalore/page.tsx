...
export const metadata = {
  title: "Digital Marketing Courses in Bangalore | 100% Job-Guaranteed",
  description:
    "Learn Digital Marketing Courses in Bangalore. In a Classroom or Online or Near You. Live Project, Certification, Internship & 100% Guaranteed Placement.",
  keywords: [
    "digital marketing courses in bangalore, best digital marketing courses bangalore, digital marketing course fees in bangalore,digital marketing courses in bangalore with placement, digital marketing certification courses in Bangalore, digital marketing course near me in Bangalore,",
  ],
  robots:
    "index, follow, max-snippet:-1, max-video-preview:-1, max-image-preview:large",
  alternates: {
    canonical:
      "https://digitalacademy360.com/digital-marketing-courses-bangalore",
  },
  openGraph: {
    title: "Digital Marketing Courses in Bangalore | 100% Job-Guaranteed",
    description:
      "Learn Digital Marketing Courses in Bangalore. In a Classroom or Online or Near You. Live Project, Certification, Internship & 100% Guaranteed Placement.",
    url: "https://digitalacademy360.com/digital-marketing-courses-bangalore",
