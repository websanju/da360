            ...
            <div className="col-lg-12">
              <div className={styles.contentBox}>
                <div className={styles.contentItem}>
                  ...
                  <p>
                    Welcome to Digital Academy 360! These terms and conditions
                    outline the rules and regulations for the use of Digital
                    Academy 360’s Website, located at
                    https://digitalacademy360.com
                  </p>
                  <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Digital Academy 360
                ...
                <div className={styles.contentItem}>
                  <h2>Communication</h2>
                  <p>
                    By filling in the form you agree and consent to receive all
                    communications at your given email, whatsapp, and mobile
                    number provided, even if this mobile number is registered
                ...
                <div className={styles.contentItem}>
                  <h2>Cookies</h2>
                  <p>
                    We employ the use of cookies. By accessing Digital Academy
                    360, you agreed to use cookies in agreement with the Digital
                    Academy 360’s Privacy Policy.
                  </p>
                  <p>
                ...
                <div className={styles.contentItem}>
                  <h2>License</h2>
                  <p>
                    Unless otherwise stated, Digital Academy 360 and/or its
                    licensors own the intellectual property rights for all
                    material on Digital Academy 360. All intellectual property
                    rights are reserved. You may access this from Digital
                    Academy 360 for your own personal use subjected to
                ...
                <div className={styles.contentItem}>
                  <h2>You must not:</h2>
                  <p>
                    Republish material from Digital Academy 360 Sell, rent or{" "}
                    <br />
                    sub-license material from Digital Academy 360 Reproduce,
                    <br />
                    duplicate or copy material from Digital Academy 360
                    <br />
                    Redistribute content from Digital Academy 360 This Agreement
                    <br />
                  ...
                  <p>
                    Digital Academy 360 reserves the right to monitor all
                ...
                <div className={styles.contentItem}>
                  ...
                  <p>
                    You hereby grant Digital Academy 360 a non-exclusive license
                ...
                <div className={styles.contentItem}>
                  ...
                  <p>
                    ...
                    compensates the absence of Digital Academy 360; and (d) the
                    ...
                    organizations listed in paragraph 2 above and are interested
                    in linking to our website, you must inform us by sending an
                    e-mail to Digital Academy 360 Please include your name, your
                    organization name, contact information as well as the URL of
                    your site, a list of any URLs from which you intend to link
                    to our Website, and a list of the URLs on our site to which
                    you would like to link. Wait 2-3 weeks for a
                    response.Approved organizations may hyperlink to our Website
                    as follows:
                  </p>
                  <ul>
                  ...
                  <p>
                    No use of Digital Academy 360’s logo or other artwork will
                ...
                <div className={styles.contentItem}>
                  <h2>Your Privacy</h2>
                  <p>
                    Please read <a href="#">Privacy Policy</a>
                  </p>
                </div>
                <div className={styles.contentItem}>
                  <h2>Your Payment</h2>
                  <p>
                    Please read <a href="#">Refund Policy</a>
                  </p>
                </div>
                <div className={styles.contentItem}>
                ...
                <div className={styles.contentItem}>
                  ...
                  <p>
                    ...
                    not obligated to or so or to respond to you directly. We do
                    not ensure that the information on this website is correct,
                    we do not warrant its completeness or accuracy; nor do we
                    promise to ensure that the website remains available or that
                ...
                <div className={styles.contentItem}>
                  ...
                  <p>
                    ...
                    in contract, in tort and for breach of statutory duty. As
                    long as the website and the information and services on the
                    website are provided free of charge, we will not be liable
