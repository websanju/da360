...
export default function courseDetail() {
  ...
  return (
    <main>
      <LeadCaptureSection
        headingLineOne={SocialMediaAndInfluencerMarketing.leadCapture.titleOne}
        headingLineTow={SocialMediaAndInfluencerMarketing.leadCapture.titleTwo}
        descriptionLineOne={
          SocialMediaAndInfluencerMarketing.leadCapture.subtitleOne
        }
        descriptionLineTow={
      ...
      <CohortDetails
        section="section1"
        cohorts={SocialMediaAndInfluencerMarketing.Cohort}
        heading={SocialMediaAndInfluencerMarketing.cohortSectionHeading}
      />
      <CourseHighlights
        section="section2"
        highlights={SocialMediaAndInfluencerMarketing.highlights}
      />
      <TrustedByLearners
      ...
      <OurSuccessStories
        section="section3"
        headerTitle={SocialMediaAndInfluencerMarketing.StoryHeader.headerTitle}
        description={SocialMediaAndInfluencerMarketing.StoryHeader.description}
      />
      <CounterOnScroll />
      {/* <LifeAtDA360
        headerTitle={
          SocialMediaAndInfluencerMarketing.LifeAtDA360Header.headerTitle
        }
        description={
          SocialMediaAndInfluencerMarketing.LifeAtDA360Header.description
        }
      /> */}
      ...
      <LearningRoadmap
        headerTitle={
          SocialMediaAndInfluencerMarketing.LearningRoadmapProps.headerTitle
        }
        description={
