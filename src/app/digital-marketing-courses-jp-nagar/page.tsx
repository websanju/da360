...
export const metadata = {
  title: "Digital Marketing Courses in JP Nagar | 100% Job-Guaranteed",
  description:
    "Learn Digital Marketing Courses in JP Nagar. In a Classroom or Online or Near You. Live Project, Certification, Internship & 100% Guaranteed Placement.",
  keywords: [
    "digital marketing courses in JP Nagar, digital marketing course in JP Nagar, digital marketing course fees in JP Nagar,digital marketing courses in JP Nagar with placement, digital marketing certification courses in JP Nagar, digital marketing course near me in JP Nagar",
  ],
  robots:
    "index, follow, max-snippet:-1, max-video-preview:-1, max-image-preview:large",
  alternates: {
    canonical:
      "https://digitalacademy360.com/digital-marketing-courses-jp-nagar",
  },
  openGraph: {
    title: "Digital Marketing Courses in JP Nagar | 100% Job-Guaranteed",
    description:
      "Learn Digital Marketing Courses in JP Nagar. In a Classroom or Online or Near You. Live Project, Certification, Internship & 100% Guaranteed Placement.",
    url: "https://digitalacademy360.com/digital-marketing-courses-jp-nagar",
